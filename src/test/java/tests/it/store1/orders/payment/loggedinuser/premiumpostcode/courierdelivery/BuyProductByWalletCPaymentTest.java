package tests.it.store1.orders.payment.loggedinuser.premiumpostcode.courierdelivery;
...
public class BuyProductByWalletCPaymentTest extends TestCase {
    ...
    @Test(description = "Store 1 buy product as logged in user by Courier delivery and WalletC")
    public void buyProductByWalletCPaymentTest() {
        ...
        miniCart.navigateToCheckoutCart();
