package tests.it.store1.orders.payment.guestuser.premiumpostcode.cashondeliverycourier;
...
public class BuyProductByCashOnDeliveryTest extends TestCase {
    ...
    @Test(description = "Store 1 buy product by Cash On Delivery courier and Cash On Delivery payment")
    public void buyProductByCashOnDelivery() {
        ...
        assertThat(checkoutDeliveryPage.getPremiumPostcodeSummaryInformation()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
