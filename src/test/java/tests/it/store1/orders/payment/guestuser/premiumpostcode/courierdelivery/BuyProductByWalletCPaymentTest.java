package tests.it.store1.orders.payment.guestuser.premiumpostcode.courierdelivery;
...
public class BuyProductByWalletCPaymentTest extends TestCase {
    ...
    @Issue("Czekamy na rozwiązanie problemu przełączenia okna WalletC w CI")
    @Test(enabled = false, description = "Store 1 buy product by Courier delivery with premium postcode and WalletC")
    public void buyProductByWalletCPaymentTest() {
        ...
        checkoutDeliveryPage
                ...
                .fillPremiumCheckoutDeliveryForm(DeliveryFactory.createPremiumDeliveryData())
        ...
        CheckoutSummaryPage checkoutSummaryPage = checkoutDeliveryPage
                .selectPaymentMethod(PaymentMethods.PaymentProviderWalletC)
        ...
        checkoutSummaryPage
                ...
                .switchToWalletCWindowAndPlaceOrder(PaymentData.walletCUserEmail, PaymentData.walletCUserPassword);
