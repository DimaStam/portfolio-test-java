package tests.pl.store2.orders.payment.loggedinuser.cashondelivery;
...
public class BuyProductByCashOnDeliveryTest extends TestCase {
    ...
    @Test(description = "Store 2 buy product as logged in user by Cash On Delivery courier and Cash On Delivery payment")
