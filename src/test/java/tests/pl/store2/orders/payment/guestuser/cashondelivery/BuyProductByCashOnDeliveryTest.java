package tests.pl.store2.orders.payment.guestuser.cashondelivery;
...
public class BuyProductByCashOnDeliveryTest extends TestCase {
    ...
    @Test(description = "Store 2 buy product by Cash On Delivery courier and Cash On Delivery payment")
    public void BuyProductByCashOnDeliveryPaymentTest(){
        ...
        ProductPage productPage = searchResultPage
                .selectProduct();
