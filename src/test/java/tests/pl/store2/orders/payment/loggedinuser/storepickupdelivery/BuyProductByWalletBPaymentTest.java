package tests.pl.store2.orders.payment.loggedinuser.storepickupdelivery;
...
public class BuyProductByWalletBPaymentTest extends TestCase {
    ...
    @Test(description = "Store 2 buy product as logged in user by courier delivery and Wallet B")
    public void BuyProductByWalletBPayPayment(){
        ...
        assertThat(checkoutDeliveryPage.getCheckoutDeliveryArea()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
