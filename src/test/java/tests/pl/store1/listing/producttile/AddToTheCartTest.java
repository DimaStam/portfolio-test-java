...
public class AddToTheCartTest extends TestCase {
    ...
    @Test(description = "Check listing add to the cart")
    public void  addToTheCart() {
        ...
        Header header = searchResultPage
                .addProductToTheCart();
        MiniCart miniCart = header
                .waitForMiniCart()
                .openMiniCart();

        assertThat(miniCart.getMiniCartContent()).isVisible();
    }
}
