...
public class WishlistButtonTest extends TestCase {
    ...
    @Test(description = "Check listing product wishlist button")
    public void productWishlistButton(){
        ...
        assertThat(searchResultPage.getProductWishlistButton()).isVisible();
    }
}