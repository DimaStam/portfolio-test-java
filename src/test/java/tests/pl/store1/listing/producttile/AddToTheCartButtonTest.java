...
public class AddToTheCartButtonTest extends TestCase {
    ...
    @Test(description = "Check listing add to the cart button")
    public void addToThecartutton(){
        ...
        assertThat(searchResultPage.getAddToTheCartButton()).isVisible();
    }
}