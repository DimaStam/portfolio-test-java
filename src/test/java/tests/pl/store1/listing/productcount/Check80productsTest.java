...
public class Check80productsTest extends TestCase {
    ...
    @Test(description = "Check listing show 80 products")
    public void check80Products() {
        ...
        Assert.assertEquals(listingPage.getProductTilesCount().count(), 80);
    }
}
