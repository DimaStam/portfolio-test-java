...
public class DisplayStore1ClubPageTest extends TestCase {
    ...
    @Test(description = "Display club page")
    public void testDisplayClubPage(){

        (new Header(page)).navigateToStore1ClubPage();

        assertThat(page).hasTitle(PageTitles.CLUB_TITLE.getValue(), new PageAssertions.HasTitleOptions().setTimeout(15000));
    }
}
