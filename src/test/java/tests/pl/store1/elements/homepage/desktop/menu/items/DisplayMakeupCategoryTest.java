...
public class DisplayMakeupCategoryTest extends TestCase {
    ...
    @Test(description = "Display makeup category link in main menu")
    public void displayMakeupCategory(){

        CategoryMenu categoryMenu = (new CategoryMenu(page));

        assertThat(categoryMenu.menu(MenuLinksTexts.MAKEUP_URL_PL.getValue())).isVisible();

        categoryMenu
                .expandSubMenu(MenuLinksTexts.MAKEUP_URL_PL.getValue())
                .navigateToCategoryPage();

        Assert.assertTrue(page.url().contains(MenuLinksTexts.MAKEUP_URL_PL.getValue()));
