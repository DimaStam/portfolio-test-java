...
public class DisplayStore2LinkTest extends TestCase {
    ...
    @Test(description = "Display store2 link")
    public void testDisplayStore1Link() {

        Header header = (new Header(page));

        assertThat(header.getStore2Link()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
    }
}