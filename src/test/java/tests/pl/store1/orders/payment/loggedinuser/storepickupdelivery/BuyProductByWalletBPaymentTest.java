package tests.pl.store1.orders.payment.loggedinuser.storepickupdelivery;
...
public class BuyProductByWalletBPaymentTest extends TestCase {
    ...
    @Issue("SUPB@C-4854")
    @Test(enabled = false, description = "Buy product by as logged in user personal pickup delivery and Wallet B")
