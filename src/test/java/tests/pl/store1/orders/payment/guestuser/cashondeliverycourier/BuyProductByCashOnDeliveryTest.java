package tests.pl.store1.orders.payment.guestuser.cashondeliverycourier;
...
public class BuyProductByCashOnDeliveryTest extends TestCase {
    ...
    @Test(description = "Buy product by Cash On Delivery courier and Cash On Delivery payment")
    public void BuyProductByCashOnDeliveryPaymentTest(){
        ...
        assertThat(productPage.getProductDescription()).isVisible();
        ...
        checkoutDeliveryPage.waitForCheckoutDeliveryPage();
