package tests.pl.store1.orders.payment.loggedinuser.lockerpickupdelivery;
...
public class BuyProductByWalletBPaymentTest extends TestCase {
    ...
    @Issue("SUPB@C-4854")
    @Test(enabled = false, description = "Buy product as logged in user by LockerPickup delivery and Wallet B payment")
    public void buyProductByWalletB(){
        ...
        checkoutDeliveryPage
                ...
                .selectDeliveryMethod(DeliveryMethods.checkoutDeliveryMethodLockerPickupXpath);
        checkoutDeliveryPage
                .waitForTotalsRequest()
                .waitForCheckoutDeliveryPage();
        CheckoutSummaryPage checkoutSummaryPage = checkoutDeliveryPage
                .selectLockerPickupDeliveryPoint()
                .selectPaymentMethod(PaymentMethods.PaymentProviderWalletB)
        ...
        checkoutSummaryPage.expandBlockItemsInCart();
