...
public class BuyProductByCodePaymentTest extends TestCase {
    ...
    @Test(description = "Buy product by courier delivery and CodePayment")
    public void buyProductByCodePayment(){
        ...
        Assert.assertTrue(productDetailsFromProductPage.entrySet().containsAll(checkoutSummaryPage.getProductData().entrySet()), "Incorect checkout summary product data");
