package tests.pl.store1.orders.payment.loggedinuser.cashondeliverycourier;
...
public class BuyProductByCashOnDeliveryTest extends TestCase {
    ...
    @Test(description = "Buy product as logged in user by Cash On Delivery courier and Cash On Delivery payment")
    public void BuyProductByCashOnDeliveryPaymentTest(){
        ...
        checkoutDeliveryPage.clickCheckoutCartButton();
        ...
        checkoutCartPage.checkCartValueBeforeOrder();
        checkoutDeliveryPage
                .waitForTotalsRequest()
                .waitForCheckoutDeliveryPage();
        ...
        checkoutSummaryPage.clickPlaceOrderButton();

        assertThat(page).hasTitle(PageTitles.SUCCESS_PAGE_PL.getValue(), new PageAssertions.HasTitleOptions().setTimeout(15000));
    }
}