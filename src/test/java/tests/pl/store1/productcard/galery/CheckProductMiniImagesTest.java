...
public class CheckProductMiniImagesTest extends TestCase {
    ...
    @Test(description = "Check product mini images test")
    public void  checkProductMiniImages() {
        ...
        assertThat(productPage.getProductMiniImage()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
    }
}