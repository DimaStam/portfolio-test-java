package tests.pl.store1.productcard.galery;
...
public class CheckFullScreenGaleryTest extends TestCase {
    ...
    @Test(description = "Check product galery test")
    public void  checkProductGalery() {
        ...
        assertThat(productPage.getExitFullScreenButton()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
        assertThat(productPage.getLeftArrowButton()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
        assertThat(productPage.getRightArrowButton()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
    }
}