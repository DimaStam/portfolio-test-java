...
public class CheckProductMainImageTest extends TestCase {
    ...
    @Test(description = "Check product main image test")
    public void  checkProductMainImage() {
        ...
        assertThat(productPage.getProductMainImage()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
    }
}
