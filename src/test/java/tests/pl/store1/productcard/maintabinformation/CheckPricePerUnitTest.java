...
public class CheckPricePerUnitTest extends TestCase {
    ...
    @Test(description = "Check price per unit")
    public void  checkPricePerUnit() {
        ...
        assertThat(productPage.getPricePerUnit()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
    }
}
