...
public class CheckProductCapacityTest extends TestCase {
    ...
    @Test(description = "Check product capacity test")
    public void  checkProductCapacity() {
        ...
        assertThat(productPage.getProductCapacity()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
    }
}
