package tests.pl.store1.productcard.productadditionalinformation;
...
public class CheckProductCompositionTest extends TestCase {
    ...
    @Test(description = "Check product composition")
    public void  checkProductComposition() {
        ...
        assertThat(productPage.getProductMenu()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
        assertThat(productPage.getProductComposition()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
    }
}
