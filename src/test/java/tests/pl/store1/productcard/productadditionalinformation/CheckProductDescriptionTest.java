...
public class CheckProductDescriptionTest extends TestCase {
    ...
    @Test(description = "Check product description")
    public void  checkProductDescription() {
        ...
        assertThat(productPage.getProductDescription()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
    }
}