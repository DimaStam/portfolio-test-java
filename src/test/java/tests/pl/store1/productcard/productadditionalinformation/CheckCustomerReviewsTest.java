...
public class CheckCustomerReviewsTest extends TestCase {
    ...
    @Test(description = "Check customer reviews")
    public void  checkCustomerReviews() {
        ...
        assertThat(productPage.getCustomerReviews()).isVisible(new LocatorAssertions.IsVisibleOptions().setTimeout(15000));
    }
}
