...
public class CheckInstallmentLabelTest extends TestCase {
    ...
    @Test(description = "Check installment label")
    public void checkInstallmentLabel() {
        ...
        assertThat(productPage.getInstallmentLabelText()).hasText(ProductData.INSTALLMENT_TEXT.getValue());
    }
}
