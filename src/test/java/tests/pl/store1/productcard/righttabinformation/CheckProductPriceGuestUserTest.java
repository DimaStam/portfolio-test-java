...
public class CheckProductPriceGuestUserTest extends TestCase {
    ...
    @Test(description = "Check if the product has price guest user")
    public void checkProductPriceGuestUser() {
