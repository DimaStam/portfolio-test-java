...
public class CheckFloatingCardStockLabelTest extends TestCase {
    ...
    @Test(description = "Check floating card stock label")
    public void  checkStockLabel() {
        ...
        assertThat(productPage.getFloatingCardStockLabel()).hasText(ProductData.STOCK_TEXT.getValue());
    }
}