...
public class CheckFloatingCardInstallmentLabelTest extends TestCase {
    ...
    @Test(description = "Check floating card installment label")
    public void checkInstallmentLabel() {
        ...
        assertThat(productPage.getInstallmentLabel()).isVisible();
        assertThat(productPage.getInstallmentLabelText()).hasText(ProductCardData.INSTALLMENT_SLOGAN.getValue());
    }
}
