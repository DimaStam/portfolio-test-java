...
public class CheckFloatingCardOrderBefore12HourTabTest extends TestCase {
    ...
    @Test(description = "Check floating card Order before 12:00 tab")
    public void  checkOrderBefore12HourTab() {
        ...
        assertThat(productPage.getOrderBefore12Tab()).isHidden(new LocatorAssertions.IsHiddenOptions().setTimeout(10000));
    }
}