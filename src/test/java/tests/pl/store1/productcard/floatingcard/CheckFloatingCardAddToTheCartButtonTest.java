...
public class CheckFloatingCardAddToTheCartButtonTest extends TestCase {
    ...
    @Test(description = "Check floating card add to the cart")
    public void  checkAddToTheCart() {
        ...
        assertThat(productPage.getAddProductToTheCartButton()).isVisible();
    }
}
